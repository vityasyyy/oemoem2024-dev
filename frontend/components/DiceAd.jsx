...
const DiceAd = () => {
    return (
        ...
        <section className="flex flex-col px-[min(10%,512px)] items-center relative gap-8 py-4 pt-32 pb-48 bg-gradient-to-b from-basicBlack-10 to-basicLightGreen-10 overflow-clip">
            ...
            <Link href="/auth/daftar" className="sm:rounded-2xl rounded-md bg-basicRed-10 text-white md:text-2xl text-lg text-center sm:px-28 px-14 md:py-3 py-1 mb-5 z-30 border-4 border-basicDarkBrown-10 hover:bg-red-900 transition-all">Daftar Sekarang</Link>
